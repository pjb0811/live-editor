...
- 8af847f: Custom renderPalette implementations can now handle mobile tap events as 'add' instead of relying on onDoubleClick, and the mobile Drawer's tap behavior has been adjusted to match this change.
