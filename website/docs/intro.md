...
| Prop              | Type                                        | Description                                                                                                                                                                            |
| ----------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `value`           | `string?`                                   | Current code (controlled). Omit it to use `Live`'s shared context; an explicit empty string remains empty.                                                                             |
| `onChange`        | `(value: string) => void?`                  | Called on every edit.                                                                                                                                                                  |
| `defaultValue`    | `string?`                                   | Initial code when `value` is omitted; falls back to the built-in template only when this is also omitted. An explicit empty string is preserved.                                       |
